...
-- ------------------------------------------------------------
-- GENERIC ORGANIZATION-OWNED TABLES
--
-- NOTE:
-- project_members is intentionally excluded because it does
-- not contain organization_id. Its policies are defined below.
-- ------------------------------------------------------------
...
-- PROJECT MEMBERS
--
-- project_members has no organization_id.
-- Organization ownership is inherited through projects.
-- ------------------------------------------------------------

drop policy if exists "active_members_select_project_members"
on public.project_members;

create policy "active_members_select_project_members"
on public.project_members
for select
to authenticated
using (
...
drop policy if exists "active_members_insert_project_members"
on public.project_members;

create policy "active_members_insert_project_members"
on public.project_members
for insert
to authenticated
with check (
...
drop policy if exists "active_members_update_project_members"
on public.project_members;

create policy "active_members_update_project_members"
on public.project_members
for update
to authenticated
using (
...
drop policy if exists "active_members_delete_project_members"
on public.project_members;

create policy "active_members_delete_project_members"
on public.project_members
for delete
to authenticated
using (
